...
DLL_PATH = os.path.abspath("flag_dll.dll")
...
# Define needed functions with argtypes/restype
...
if not success or written.value != dll_path_len:
    print("[!] Failed to write DLL path into target process")
    sys.exit(1)
